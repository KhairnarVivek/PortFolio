    ...
    <footer className="bg-gray-900">
      <div className=" md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#ffffff19] py-7">
        <h1
         ...
         text-white"
        >
          <span className="text-teal-400 ">Free</span> unitl you're ready to
          launch
        </h1>
        <div>
          <input
            ...
            className="text-gray-800 sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2 rounded px-2 
            focus:outline-none"
          />
          <button
      ...
      >
        <span>© 2020 Apply. All rights reserved.</span>
