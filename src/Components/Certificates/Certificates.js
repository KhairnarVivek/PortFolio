...
const Certificates = () => {
  return (
    <div className="mt-1 bg-gradient-to-tr from-teal-300 via-amber-200 to-cyan-400">
      <div>
        <div>
          <div className="grid sm0:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[108px] sm0:p-10 md:px-20">
            ...
            <div className="sm0:flex sm0:justify-center items-cente">
              <div className="sm0:w-60 md:w-96 md:mb-10 ">
                <img
                  className="rounded-xl md:mt-10 hover:shadow-2xl hover:shadow-gray-300 hover:scale-125 duration-700"
                  src={PRE_CAT}
                />
              </div>
            </div>
            ...
            <div className="sm0:flex sm0:justify-center items-cente">
              <div className="sm0:w-60 md:w-96 m05mb-10">
                <img
                  className="rounded-xl mt-10 hover:shadow-2xl hover:shadow-gray-300 hover:scale-125 duration-700"
                  src={CDAC_MARKSHEET}
                />
              </div>
            </div>
          ...
          <div className="grid sm0:grid-cols-1 md:grid-cols-2 gap-10 sm0:p-10 md:p-20">
            <div>
              <img
                className="rounded-xl hover:shadow-2xl hover:shadow-gray-300 hover:scale-105 duration-700"
                src={Core_Java}
              />
            </div>
            <div>
